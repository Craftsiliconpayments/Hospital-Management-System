                              ...
                              <div class="col-12">
                                ...
                                <table class="table table-editable-1 align-middle table-edits">
                                  ...
                                  <tr v-for="(allergy, index) in allergies" :key="index" class="allergy-row">
                                    ...
                                    <td>
                                      <select readonly="" v-model="allergy.type" class="form-control form-select" title="Select Allergy Type">
                                    ...
                                    <td>
                                      <input readonly v-model="allergy.allergen" type="text" class="form-control" placeholder="Enter Allergen" title="Enter Allergen">
                                    </td>
                                    <td>
                                      <input readonly v-model="allergy.reaction" type="text" class="form-control" placeholder="Enter Reaction" title="Enter Reaction">
                                    </td>
                                  ...
                                  <tfoot>
                                  <tr>
                                    <td colspan="5" class="bg-light add-field-1 cursor-pointer d-none" @click="addAllergy">
                              ...
                              <div class="col-12">
                                <table class="table table-editable-2 align-middle table-edits">
                                  ...
                                  <tr v-for="(immunization, index) in immunizations" :key="index" class="immunization-row">
                                    <td style="width: 80px">{{ index + 1 }}.</td>
                                    <td>
                                      <select readonly="" v-model="immunization.type" class="form-control form-select" title="Select Immunization">
                                    ...
                                    <td>
                                      <input readonly v-model="immunization.date" class="form-control" type="date">
                                    </td>
                                    <td class="text-right">
                                      <a class="btn btn-light btn-rounded waves-effect btn-circle btn-transparent d-none" @click="removeImmunization(index)" title="Cancel">
                                        <i class="bx bx-x"></i>
                                      </a>
                                    </td>
                                  </tr>
                                  ...
                                  <tfoot>
                                  <tr>
                                    <td colspan="4" class="bg-light add-field-2 cursor-pointer d-none" @click="addImmunization">
            <span class="d-flex align-items-center text-uppercase">
              <i class="dripicons-plus mr-5 d-flex justify-content-center align-items-center font-21"></i>
