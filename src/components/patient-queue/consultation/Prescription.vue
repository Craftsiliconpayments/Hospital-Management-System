      ...
      <div class="page-content">
        <div class="container-fluid">
                      ...
                      <div class="row">
                        <div class="col-12 mb-2">
                          <div class="bg-warning border-2 bg-soft p-3 mb-4 d-flex align-items-center">
                            <i class="fas fa-prescription font-28 mr-15px"></i>
                            <p class="fw-semibold mb-0 pb-0 text-uppercase">Write a prescription for the patient</p>
                          </div>
                        </div>
                              ...
                              <div class="col-12">
                                  ...
                                  <table class="table table-editable-2 align-middle table-edits">
                                    ...
                                    <tr v-for="(prescription, index) in prescriptions" :key="index">
                                      ...
                                      <td>
                                        <select v-model="prescription.medicine" class="form-select form-control">
                                          ...
                                          <option value="Amoxicillin/Clavulanic Acid">Amoxicillin/Clavulanic Acid (Augmentin)</option>
                                          ...
                                          <option value="Duloxetine">Duloxetine (Cymbalta)</option>
                                          <option value="Enalapril">Enalapril</option>
                                          <option value="Escitalopram">Escitalopram (Lexapro)</option>
                                          <option value="Esomeprazole">Esomeprazole (Nexium)</option>
                                          ...
                                          <option value="Ipratropium">Ipratropium (Atrovent)</option>
                                          ...
                                          <option value="Montelukast">Montelukast (Singulair)</option>
                                          ...
                                          <option value="Pantoprazole">Pantoprazole (Protonix)</option>
                                      ...
                                      <td>
                                        <div class="d-flex">
                                          <input type="text" v-model="prescription.quantity" class="form-control" placeholder="Quantity">
                                          <select v-model="prescription.unit" class="form-select form-control">
                                            ...
                                            <option value="Milliliter(s)">Milliliter(s) (ML)</option>
                                            <option value="Drop(s)">Drop(s)</option>
                                            <option value="Gram(s)">Gram(s) (G)</option>
                                            <option value="Milligram(s)">Milligram(s) (MG)</option>
                                            <option value="Microgram(s)">Microgram(s) (MCG)</option>
                                            <option value="Unit(s)">Unit(s)</option>
                                            <option value="Puff(s)">Puff(s)</option>
                                            <option value="Spray(s)">Spray(s)</option>
                                            <option value="Suppository">Suppository</option>
                                            <option value="Patch">Patch</option>
                                            <option value="Ounce(s)">Ounce(s) (OZ)</option>
                                            <option value="Teaspoon(s)">Teaspoon(s) (TSP)</option>
                                            <option value="Tablespoon(s)">Tablespoon(s) (TBSP)</option>
                                            <option value="Inhalation(s)">Inhalation(s)</option>
                                            <option value="Dropper(s)">Dropper(s)</option>
                                      ...
                                      <td>
                                        <div class="d-flex">
                                          <input type="text" v-model="prescription.duration" class="form-control" placeholder="Duration">
                                          <select v-model="prescription.durationType" class="form-select form-control">
                                      ...
                                      <td class="text-right d-flex align-items-center justify-content-end">
                                        <a class="btn btn-light btn-rounded waves-effect btn-circle btn-transparent" @click="removePrescription(index)" title="Remove">
                                          <i class="bx bx-x"></i>
                                        </a>
                                      </td>
                                    </tr>
                                    ...
                                    <tfoot>
                                    <tr>
                                      <td colspan="5" class="bg-light add-field-2 cursor-pointer" @click="addPrescription">
          <span class="d-flex align-items-center text-uppercase">
            ...
            <span class="pl-5">Add Prescription</span>
          </span>
                                      </td>
                                    </tr>
                                    </tfoot>
                        ...
                        <div class="col-12">
                          <div class="d-flex justify-content-end">
                            <button @click="submitPrescription()" class="btn btn-primary waves-effect waves-light text-uppercase mr-3 me-2">
...
// return the array of pages
    ...
    // Method to remove a prescription row by index
    ...
    getPrescription() {
      const data = new FormData();
      data.append("function", "getPrescription");
      data.append("visitCode", sessionStorage.getItem("visitCode"));
      execute(data, patient)
          .then((res) => {
            this.loading = false
            if (res.data.success) {

              if (res.data && res.data.data && res.data.data.prescriptions) {
    ...
    submitPrescription() {
      const data = new FormData();
      data.append("function", "submitPrescription");
      data.append("idNo", sessionStorage.getItem("idNo"));
      data.append("visitCode", sessionStorage.getItem("visitCode"));
      data.append("sessionNames", sessionStorage.getItem("sessionNames"));
      data.append("prescriptions", JSON.stringify(this.prescriptions));
      data.append("zone", sessionStorage.getItem("zone"));
      execute(data, patient)
          .then((res) => {
            this.loading = false
            if (res.data.success) {
