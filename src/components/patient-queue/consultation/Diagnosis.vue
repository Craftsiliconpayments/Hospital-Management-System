                      ...
                      <div class="row">
                        <div class="col-12 mb-2">
                          <div class="bg-warning border-2 bg-soft p-3 mb-4 d-flex align-items-center">
                            <i class="mdi mdi-stethoscope font-28 mr-15px"></i>
                            <p class="fw-semibold mb-0 pb-0 text-uppercase">Record Your Diagnosis Here</p>
                          </div>
                        </div>
                              ...
                              <div class="col-12">
                                  ...
                                  <table class="table table-editable-2 align-middle table-edits">
                                    ...
                                    <tr v-for="(diagnosis, index) in diagnoses" :key="index">
                                      ...
                                      <td>
                                        <input class="form-control" type="text" v-model="diagnosis.diagnosis" placeholder="Search By Diagnosis Name">
                                      </td>
                                      <td>
                                        <select v-model="diagnosis.type" class="form-control form-select">
                                      ...
                                      <td class="text-right d-flex align-items-center justify-content-end">
                                        <a class="btn btn-light btn-rounded waves-effect btn-circle btn-transparent" @click="removeDiagnosis(index)" title="Remove">
                                          <i class="bx bx-x"></i>
                                        </a>
                                      </td>
                                    </tr>
                                    ...
                                    <tfoot>
                                    <tr>
                                      <td colspan="4" class="bg-light add-field-2 cursor-pointer" @click="addDiagnosis">
            ...
            <span class="pl-5">Add Diagnosis</span>
                        ...
                        <div class="col-12">
                          <div class="d-flex justify-content-end">
                            <button @click="addDiagnoses()" class="btn btn-primary waves-effect waves-light text-uppercase mr-3 me-2">
                      ...
                      <div class="row">
                        <div class="col-12 mb-2">
                          <div class="bg-info border-2 bg-soft p-3 mb-4 d-flex align-items-center">
                            ...
                            <p class="fw-semibold mb-0 pb-0 text-uppercase">Previous Diagnosis</p>
                          </div>
                        </div>
                        ...
                        <div class="col-12">
                          <div class="table-responsive">
                            <table class="table table-striped">
                              ...
                              <tbody>
                              <tr v-for="(item, index) in diagnosesHistory" :value="item" :key="index">
...
export default {
  ...
  data() {
    return {
      ...
      diagnoses: [{ id: 1, diagnosis: "", type: "New" }],
      diagnosesHistory: [{
        id: null,
        idNo:null,
        visitCode:null,
...
// return the array of pages
    ...
    addDiagnosis() {
      const newId = this.diagnoses.length + 1;
      this.diagnoses.push({ id: newId, name: "", type: "New" });
    },
    // Method to remove a diagnosis row by index
    ...
    addDiagnoses() {
      this.loading = true
      const data = new FormData();
      data.append("function", "addDiagnoses");
    ...
    getDiagnoses() {
      const data = new FormData();
      data.append("function", "getDiagnoses");
      data.append("diagnoses", JSON.stringify(this.diagnoses));
      data.append("visitCode", sessionStorage.getItem("visitCode"));
      data.append("idNo", sessionStorage.getItem("idNo"));
      execute(data, patient)
          .then((res) => {
            ...
            if (res.data.success) {
              ...
              if (res.data && res.data.data && res.data.data.diagnoses) {
                this.diagnoses = res.data.data.diagnoses
              }

              if (res.data && res.data.data && res.data.data.diagnosesHistory) {
                this.diagnosesHistory = res.data.data.diagnosesHistory
              }
