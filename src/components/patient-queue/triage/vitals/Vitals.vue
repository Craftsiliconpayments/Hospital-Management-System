...
<template>
  ...
  <head>
    ...
    <meta content="{{patientsDetails.patient.names}}" name="author" />
    <!-- App favicon -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-white border-bottom">
                  <h4 class="card-title text-uppercase">Vitals Update: Record and Review Patient Health Data</h4>
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.weight" type="text" maxlength="25" name="weight" class="form-control" placeholder="Enter weight in KGs" title="Enter the patient's weight in kilograms">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.height" type="text" maxlength="25" name="height" class="form-control" placeholder="Enter height in Meters" title="Enter the patient's height in meters">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.temperature"  type="text" maxlength="25" name="temperature" class="form-control" placeholder="Enter temperature in &deg;C" title="Enter the patient's temperature in degrees Celsius">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.systolicBP"  type="text" maxlength="25" name="systolic_bp" class="form-control" placeholder="Enter Systolic Blood Pressure" title="Enter the systolic blood pressure in mmHg">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.diastolicBP"  type="text" maxlength="25" name="diastolic_bp" class="form-control" placeholder="Enter Diastolic Blood Pressure" title="Enter the diastolic blood pressure in mmHg">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.respiratoryRate"  type="text" maxlength="25" name="respiratory_rate" class="form-control" placeholder="Enter respiratory rate per minute" title="Enter the respiratory rate in breaths per minute">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.heartRate"  type="text" maxlength="25" name="heart_rate" class="form-control" placeholder="Enter heart rate per minute" title="Enter the heart rate in beats per minute">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.bloodSugarF"  type="text" maxlength="25" name="blood_sugar_f" class="form-control" placeholder="Enter fasting blood sugar" title="Enter fasting blood sugar level in mg/dL">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.bloodSugarR"  type="text" maxlength="25" name="blood_sugar_r" class="form-control" placeholder="Enter random blood sugar" title="Enter random blood sugar level in mg/dL">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.SPO2"  type="text" maxlength="25" name="spo2" class="form-control" placeholder="Enter oxygen saturation" title="Enter the oxygen saturation percentage">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <select v-model="vitals.assessOxygenSupplementation" name="oxygen" class="form-control form-select" id="oxygen-select" title="Select the level of oxygen supplementation required by the patient.">
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <input v-model="vitals.urineOutput"  type="text" name="urine_output" class="form-control" placeholder="Enter urine output in ml" title="Enter the total urine output in milliliters">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <select v-model="vitals.assessLevelOfConsciousness"  name="consciousness" class="form-control form-select" id="avpu-select" title="Assess the level of consciousness of the patient.">
                            <option value="" disabled selected>N/A</option>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <select  v-model="vitals.assessMobility" name="mobility" class="form-control form-select" id="mobility-select" title="Select the level of mobility based on the patient's ability to move.">
                            <option value="" disabled selected>N/A</option>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-4">
                          ...
                          <select  v-model="vitals.assessTrauma" name="trauma" class="form-control form-select" id="trauma-select" title="Select the presence and severity of trauma.">
                            <option value="" disabled selected>N/A</option>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-4">
                          ...
                          <textarea  v-model="vitals.patientNotes" name="patientNotes" id="patient-notes" class="form-control" placeholder="Enter relevant notes about the patient's condition, treatment, or observations here" rows="4"></textarea>
                        </div>
                      </div>
                ...
                <div class="card-footer bg-white border-top py-3">
                  <div>
                    <button @click="addVitals()" class="btn btn-primary waves-effect waves-light text-uppercase mr-3 me-2">

                      <div v-if="loading" class="spinner-border text-white m-0" height="20px" width="20px" role="status">
                        <span class="sr-only">Loading...</span>
                      </div>

                      <div v-if="!loading">  <i class="mdi mdi-check font-size-16 align-middle me-2"></i> Submit</div>

                    </button>

                    <button @click="clearVitals()" type="button" class="btn btn-outline-secondary waves-effect waves-light text-uppercase me-3">
                      <i class="mdi mdi-close font-size-16 align-middle me-2"></i> Clear Form
                    </button>
                  </div>
...
export default {
  name: "QueueTriageAcknowledge",
  components: {ToolBarPatientQue, ToolBarPatient, NavigationBar},
  data() {
    return {
      patientInitials:"",
  ...
  watch: {
    ...
    'vitals.weight': function() {
      this.calculateBMI();
    },
    'vitals.height': function() {
      this.calculateBMI();
    }
...
// return the array of pages
    ...
    addVitals() {
      this.vitals.visitCode = sessionStorage.getItem("visitCode")
      this.vitals.patientIDNo = sessionStorage.getItem("idNo")
      this.loading = true
      const data = new FormData();
      data.append("function", "addVitals");
      data.append("vitals", JSON.stringify(this.vitals));
      data.append("doctor", sessionStorage.getItem("sessionNames"));
      execute(data, patient)
          .then((res) => {
            this.loading = false
            if (res.data.success) {
