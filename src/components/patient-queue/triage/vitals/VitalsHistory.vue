            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-white border-bottom">
                  <h4 class="card-title text-uppercase">Vitals History: View Patient's Recorded Vital Signs Over Time</h4>
                </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-sm table-bordered">
                        ...
                        <tr>
                          ...
                          <th>Date & Time</th>
                          <th>Facility</th>
                          <th title="Type of Visit">Visit Type</th>
...
<!--                          <th></th>-->
                        ...
                        <tbody>
                        <tr v-for="(item, index) in vitals" :value="item" :key="index">
                          <td>{{index+1}}</td>
                          ...
                          <td>{{item.bmi}}</td>
<!--                          <td>
                            <button class="btn-sm btn btn-primary text-uppercase">Details</button>
                          </td>-->
                        </tr>
                        </tbody>
                        ...
                        <tr>
                          ...
                          <td colspan="3">3 Visits</td>
                          <td title="Average Weight">71.67</td>
                          <td title="Average Height">1.75</td>
                          <td title="Average DBP">80</td>
                          <td title="Average Temperature">37.23</td>
                          <td title="Average Respiratory Rate">18</td>
                          <td title="Average Heart Rate">71.33</td>
                          <td title="Average Urine Output">490</td>
                          <td title="Average Fasting Blood Sugar">90</td>
                          <td title="Average Random Blood Sugar">105</td>
                          <td title="Average SPO2">98%</td>
                          <td>-</td>
                          <td>-</td>
                          <td>-</td>
                          <td>-</td>
                          <td title="Average BMI">23.01</td>
                          <td></td>
                        </tr>
                        </tfoot>
                      </table>
                ...
                <div class="card-footer bg-white border-top py-3 d-none">
                  <div>
                    <button class="btn btn-primary waves-effect waves-light text-uppercase mr-3 me-2">
                      <i class="mdi mdi-check font-size-16 align-middle me-2"></i>  Submit
                    </button>
...
// return the array of pages
    ...
    getVitals() {
      this.vitals.splice(0)
      this.loading = true
      const data = new FormData();
      data.append("function", "getVitals");
      ...
      data.append("patientIDNo", sessionStorage.getItem("idNo"));
      execute(data, patient)
          .then((res) => {
            this.loading = false
            if (res.data.success) {
              this.vitals = res.data.data.vitals
