          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Kelvin Njuguna</h4>
                ...
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">Kelvin Njuguna</a></li>
                  </ol>
                </div>
              ...
              <div class="card">
                ...
                <div class="kev-card-nav">
                  <div class="card-header text-white text-uppercase ">
                    <h4 class="card-title">
                      <div>
                        <span class="mb-0">Kelvin Njuguna</span>
                ...
                <div class="card-header bg-white border-bottom">
                  <h4 class="card-title text-uppercase">Patient Diagnosis & Findings History: Overview of Historical Visit Records</h4>
                </div>
...
<!--                          <td>
                        ...
                        <tr>
                          <td colspan="5"><strong>Total Visits:</strong></td>
                          <td colspan="3">4</td>
