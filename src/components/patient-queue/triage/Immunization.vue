        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-white border-bottom">
                  <h4 class="card-title text-uppercase">Allergies and Immunizations: Enter Patient Allergic Reactions and Vaccination History</h4>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="col-12 mb-2">
                    <div class="bg-warning border-2 bg-soft p-3 mb-4 d-flex align-items-center">
                      <i class="mdi mdi-alert-outline font-28 mr-15px"></i>
                      <p class="fw-semibold mb-0 pb-0 text-uppercase">Allergies</p>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          ...
                          <table class="table table-editable-1 align-middle table-edits">
                            ...
                            <tbody>
                            <tr v-for="(allergy, index) in allergies" :key="index" class="allergy-row">
                              <td style="width: 80px">{{ index + 1 }}.</td>
                              <td>
                                <select v-model="allergy.type" class="form-control form-select" title="Select Allergy Type">
                              ...
                              <td>
                                <input v-model="allergy.allergen" type="text" class="form-control" placeholder="Enter Allergen" title="Enter Allergen">
                              </td>
                              <td>
                                <input v-model="allergy.reaction" type="text" class="form-control" placeholder="Enter Reaction" title="Enter Reaction">
                              </td>
                              <td class="text-right">
                                <a class="btn btn-light btn-rounded waves-effect btn-circle btn-transparent" @click="removeAllergy(index)" title="Cancel">
                                  <i class="bx bx-x"></i>
                                </a>
                              </td>
                            </tr>
                            ...
                            <tfoot>
                            <tr>
                              <td colspan="5" class="bg-light add-field-1 cursor-pointer" @click="addAllergy">
            <span class="d-flex align-items-center text-uppercase">
              ...
              <span class="pl-5">Add Allergy</span>
            </span>
                              </td>
                            </tr>
                            </tfoot>
                  ...
                  <div class="col-12 mb-2">
                    <div class="bg-info border-2 bg-soft p-3 mb-4 d-flex align-items-center">
                      ...
                      <p class="fw-semibold mb-0 pb-0 text-uppercase">Immunizations</p>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <table class="table table-editable-2 align-middle table-edits">
                            ...
                            <tbody>
                            <tr v-for="(immunization, index) in immunizations" :key="index" class="immunization-row">
                              <td style="width: 80px">{{ index + 1 }}.</td>
                              <td>
                                <select v-model="immunization.type" class="form-control form-select" title="Select Immunization">
                                  <option value="" disabled>-- Select Immunization --</option>
                              ...
                              <td>
                                <input v-model="immunization.date" class="form-control" type="date">
                              </td>
                              <td class="text-right">
                                <a class="btn btn-light btn-rounded waves-effect btn-circle btn-transparent" @click="removeImmunization(index)" title="Cancel">
                                  <i class="bx bx-x"></i>
                                </a>
                              </td>
                            </tr>
                            ...
                            <tfoot>
                            <tr>
                              <td colspan="4" class="bg-light add-field-2 cursor-pointer" @click="addImmunization">
            <span class="d-flex align-items-center text-uppercase">
              <i class="dripicons-plus mr-5 d-flex justify-content-center align-items-center font-21"></i>
              <span class="pl-5">Add Immunization</span>
            </span>
                              </td>
                            </tr>
                            </tfoot>
                ...
                <div class="card-footer bg-white border-top py-3">
                  <div>
                    <button @click="updateAllergies()" class="btn btn-primary waves-effect waves-light text-uppercase mr-3 me-2">
                    ...
                    <button  type="button" class="btn btn-outline-secondary waves-effect waves-light text-uppercase me-3">
...
export default {
  name: "VitalsHistory",
  components: {ToolBarPatientQue, NavigationBar},
  data() {
    return {
      patientInitials:"",
      ...
      allergies: [
        { type: '', allergen: '', reaction: '' }, // Initial row
      ],
      immunizations: [
        { type: '', date: '' }, // Initial row
      ],
...
// return the array of pages
      ...
      execute(data, patient)
          .then((res) => {
            ...
            if (res.data.success) {
              ...
              if (res.data && res.data.data && res.data.data.immunizations) {
                this.immunizations = res.data.data.immunizations
              }


              if (res.data && res.data.data && res.data.data.allergies) {
    ...
    updateAllergies() {
      this.loading = true
      const data = new FormData();
      data.append("function", "updateAllergies");
      data.append("idNo", sessionStorage.getItem("idNo"));
      data.append("immunizations", JSON.stringify(this.immunizations));
      data.append("allergies", JSON.stringify(this.allergies));
      execute(data, patient)
          .then((res) => {
            this.loading = false
            if (res.data.success) {
    ...
    addAllergy() {
      this.allergies.push({ type: '', allergen: '', reaction: '' });
    },
    removeAllergy(index) {
      this.allergies.splice(index, 1);
    },
    addImmunization() {
      this.immunizations.push({ type: '', date: '' });
    },
