        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header bg-white border-bottom">
                  <h4 class="card-title text-uppercase">Chronic Illnesses: Record and Update Patient's Ongoing Medical Conditions and Treatment History</h4>
                      ...
                      <div class="row">
                        <div class="col-12">
                          ...
                          <table class="table table-editable-1 align-middle table-edits">
                            ...
                            <tbody>
                            <tr v-for="(illness, index) in chronicIllnesses" :key="index">
                              <td>{{ index + 1 }}.</td>
                              <td>
                                <select v-model="illness.type" class="form-control form-select" title="Select Chronic Illness">
                              ...
                              <td>
                                <input v-model="illness.date" type="date" class="form-control" title="Enter Date Diagnosed">
                              </td>
                              <td>
                                <select v-model="illness.severity" class="form-control form-select" title="Select Severity">
                              ...
                              <td class="text-right">
                                <a @click="removeIllness(index)" class="btn btn-light btn-rounded waves-effect btn-circle btn-transparent" title="Cancel">
                                  <i class="bx bx-x"></i>
                                </a>
                              </td>
                            </tr>
                            ...
                            <tfoot>
                            <tr>
                              <td colspan="5" class="bg-light add-field-1 cursor-pointer" @click="addIllness">
            <span class="d-flex align-items-center text-uppercase">
              ...
              <span class="pl-5">Add Chronic Illness</span>
            </span>
                              </td>
                            </tr>
                            </tfoot>
                ...
                <div class="card-footer bg-white border-top py-3">
                  <div>
                    <button @click="updateChronicIllnesses()" class="btn btn-primary waves-effect waves-light text-uppercase mr-3 me-2">
...
// return the array of pages
      ...
      execute(data, patient)
          .then((res) => {
            ...
            if (res.data.success) {
              ...
              if (res.data && res.data.data && res.data.data.chronicIllnesses) {
                this.chronicIllnesses = res.data.data.chronicIllnesses
              }
    ...
    updateChronicIllnesses() {
      this.loading = true
      const data = new FormData();
      data.append("function", "updateChronicIllnesses");
      data.append("idNo", sessionStorage.getItem("idNo"));
      data.append("chronicIllnesses", JSON.stringify(this.chronicIllnesses));
      execute(data, patient)
          .then((res) => {
            this.loading = false
            if (res.data.success) {
    ...
    addIllness() {
      this.chronicIllnesses.push({ type: '', date: '', severity: '' });
    },
    removeIllness(index) {
      this.chronicIllnesses.splice(index, 1);
    },
