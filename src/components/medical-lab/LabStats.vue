                    ...
                    <div class="col-lg-4">
                      <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                          ...
                          <img :src="'./logos/county_logo.png'" alt="Your Logo" class="avatar-md rounded-circle img-thumbnail">
                        </div>
...
export default {
  ...
  methods:{
    labErrorRateGauge(){
      Highcharts.chart('lab-error-rate-gauge', {
        chart: {
          type: 'gauge',
        ...
        yAxis: {
          min: 0,
          max: 100, // Gauge max value set to 100 for percentage
          ...
          labels: {
            ...
            format: '{value}%', // Show percentage on labels
            formatter: function () {
              return this.value === 10 ? '10% Lab Test Error Rate' : this.value + '%';
            }
          },
          lineWidth: 0,
          plotBands: [{
            from: 0,
            to: 5,
            color: '#55BF3B', // Green: Low error rate (Good)
            thickness: 20
          }, {
            from: 5,
            to: 15,
            color: '#DDDF0D', // Yellow: Moderate error rate
            thickness: 20
          }, {
            from: 15,
            to: 100,
            color: '#DF5353', // Red: High error rate (Critical)
            thickness: 20
          }]
        },
        ...
        series: [{
          name: 'Error Rate',
          data: [10], // Error rate in percentage
          tooltip: {
            valueSuffix: '%'
          },
          dataLabels: {
            format: '{y}%', // Show percentage
            borderWidth: 0,
            color: (
            ...
            formatter: function() {
              const totalTests = 500; // Replace with the actual total number of tests
              const errorTests = (this.y / 100) * totalTests;
              return `${this.y}%, ${Math.round(errorTests)} errors out of ${totalTests} tests`;
            }
          },
          dial: {
            radius: '80%',
    ...
    testTypeGraph(){
      Highcharts.chart('TestTypeGraph', {
        chart: {
          type: 'pictorial',
          backgroundColor: '#d5eef561',
        ...
        series: [{
          ...
          data: [120, 100], // Female, Male
          color: '#007BFF', // Healthcare Blue
          borderColor: '#0056b3', // Darker Blue for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }, {
          name: 'Urinalysis',
          data: [90, 85], // Female, Male
          color: '#28A745', // Clinical Green
          borderColor: '#218838', // Darker Green for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }, {
          name: 'Liver Function Tests (LFT)',
          data: [45, 55], // Female, Male
          color: '#FFC107', // Diagnostic Yellow
          borderColor: '#e0a800', // Darker Yellow for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }, {
          name: 'Kidney Function Tests (KFT)',
          data: [110, 120], // Female, Male
          color: '#FD7E14', // Surgical Orange
          borderColor: '#d86d11', // Darker Orange for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }, {
          name: 'COVID-19 PCR Test',
          data: [80, 70], // Female, Male
          color: '#6F42C1', // Medical Purple
          borderColor: '#5936a6', // Darker Purple for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }, {
          name: 'Blood Glucose Test',
          data: [100, 95], // Female, Male
          color: '#6C757D', // Patient Gray
          borderColor: '#5a6268', // Darker Gray for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }, {
          name: 'Others',
          data: [70, 65], // Female, Male (Combined total for all other tests)
          color: '#20C997', // Supportive Teal
          borderColor: '#1ab394', // Darker Teal for Outline
          //borderWidth: 2,
          fillColor: '#E9ECEF' // Default color for blank area
        }]
    ...
    containerAvgTime(){
      Highcharts.chart('containerAvgTime', {
        chart: {
          type: 'column'
        },
        title: {
        ...
        yAxis: {
          ...
          opposite: false // Keep yAxis on the left for the column series
        },
        yAxis: [{
          min: 0,
          title: {
          ...
          opposite: true // Place this yAxis on the right side for the line series
        }],
        legend: {
          enabled: true // Enable legend to differentiate labs
        },

        tooltip: {
          shared: true,
          valueSuffix: ' Hrs',  // Add the suffix "Hrs" to the value
          valueDecimals: 2      // Number of decimals in the value
        },
        ...
        series: [{
          ...
          type: 'spline', // Set this series type to line
          color: '#FF6347', // Tomato
          data: [
            ['Monday', 50],  // Monday
            ['Tuesday', 60],  // Tuesday
            ['Wednesday', 55],  // Wednesday
            ['Thursday', 70],  // Thursday
            ['Friday', 65],  // Friday
            ['Saturday', 80],  // Saturday
            ['Sunday', 75]   // Sunday
          ],
          tooltip: {
            shared: true,
            valueSuffix: ' Tests',  // Add the suffix "Hrs" to the value
            valueDecimals: 0      // Number of decimals in the value
          },
          yAxis: 1, // Link this series to the second yAxis (for patients)
          marker: {
            enabled: true
          }
        }]
  ...
  mounted() {
    this.labErrorRateGauge()
    this.testTypeGraph()
    this.containerAvgTime()
    this.radialPie()
